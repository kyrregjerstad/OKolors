...
export const actions: Actions = {
	updateProfile: async event => {
		...
		if (profileError) {
			return setError(profileForm, "full_name", "Error updating your profile, please try again later.");
		}
	...
	updateEmail: async event => {
		...
		if (emailError) {
			return setError(emailForm, "email", "Error updating your email, please try again later.");
		}
	...
	updatePassword: async event => {
		...
		if (passwordError) {
			return setError(passwordForm, "password", "Error updating your password, please try again later.");
		}
